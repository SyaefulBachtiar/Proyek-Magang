...
import { CalendarDays, Captions, MessageSquareText, Pencil, Save, SquareCheck, Tags, UserRoundPlus, X } from "lucide-react";
import { usePage } from "@inertiajs/react";
import { CKEditor } from "@ckeditor/ckeditor5-react";
import ClassicEditor from "@ckeditor/ckeditor5-build-classic";

export default function Card_kanban({ cardTitle, onClose }) {
    // user
        ...
        <div className="w-screen h-screen fixed top-0 left-0 bg-black/20 flex justify-center items-center z-50">
            ...
            >
                ...
                <div className="px-4 flex-1 flex flex-col lg:flex-row overflow-y-auto gap-4 ">
                    {/* Konten Kiri */}
                    <div className="flex flex-col gap-4 w-full py-4 lg:w-1/2 border-r-0 lg:border-r-2 border-gray-200 pr-0 lg:pr-4 overflow-y-auto">
                        {/* Avatar */}
