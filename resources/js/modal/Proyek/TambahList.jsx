...
export default function TambahList ({id, id_board, close}) {
    ...
    return (
        <div className="fixed top-0 bg-black/20 w-screen h-screen z-50 flex justify-center items-center p-4">
            <div className="p-4 bg-white relative rounded-lg w-[95vw] max-w-md sm:w-[500px] sm:p-5 sm:px-8">
                <X
                    onClick={close}
                ...
                <form onSubmit={handleSubmit}>
                    <div className="mt-8 sm:mt-10 mb-6">
                        <h1 className="text-xl sm:text-2xl font-semibold">Tambah List</h1>
                    </div>
                    ...
                    <div className="flex flex-col-reverse sm:flex-row sm:justify-end gap-3">
                        <button
                            type="button"
                            onClick={close}
                            className="w-full sm:w-auto px-4 py-2 text-gray-600 bg-gray-200 rounded hover:bg-gray-300 transition-colors"
                            disabled={loading}
                        >
                            Batal
                        </button>
